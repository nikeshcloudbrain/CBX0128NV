...
#Code obfuscation
-keepclassmembers class com.allhdvideofree.downloader.videodownloader.model** { <fields>; }
-keep public class  com.allhdvideofree.downloader.videodownloader.model** {
  public protected *;
}
#OLD
