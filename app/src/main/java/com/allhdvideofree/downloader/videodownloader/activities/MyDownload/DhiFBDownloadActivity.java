...
public class DhiFBDownloadActivity extends DhiActivityBase implements FileListClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhi_fb_downloads);

        rvFileList = findViewById(R.id.rv_fileList);
        swiperefresh = findViewById(R.id.swiperefresh);
        tvNoResult = findViewById(R.id.tv_NoResult);

        setToolBar(DhiFBDownloadActivity.this,"Facebook Downloader");
...
//            Prefences.setWATree(this, data.toString());
    ...
    public void getAllFiles() {
        ...
        File[] listFiles = MyUtils.RootDirectoryFacebookShow.listFiles();
        if (listFiles != null) {
