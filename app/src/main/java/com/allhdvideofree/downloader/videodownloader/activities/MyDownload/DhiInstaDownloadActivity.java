...
public class DhiInstaDownloadActivity extends DhiActivityBase implements FileListClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhi_download_insta);


        rvFileList = (RecyclerView) findViewById(R.id.rv_fileList);
        swiperefresh = (SwipeRefreshLayout) findViewById(R.id.swiperefresh);
        tvNoResult = (TextView) findViewById(R.id.tv_NoResult);

        setToolBar(DhiInstaDownloadActivity.this,"Instagram Downloader");
...
//            Prefences.setWATree(this, data.toString());
    ...
    public void getAllFiles() {
        ...
        File[] listFiles = MyUtils.RootDirectoryInstaShow.listFiles();
        if (listFiles != null) {
