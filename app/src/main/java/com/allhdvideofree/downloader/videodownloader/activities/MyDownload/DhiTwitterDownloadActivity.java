...
public class DhiTwitterDownloadActivity extends DhiActivityBase implements FileListClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhi_twitter_downloads);

        rvFileList = findViewById(R.id.rv_fileList);
        swiperefresh = findViewById(R.id.swiperefresh);
        tvNoResult = findViewById(R.id.tv_NoResult);

        setToolBar(DhiTwitterDownloadActivity.this,"Twitter Downloader");
