...
import com.allhdvideofree.downloader.videodownloader.Allweb.DhiFbBrowserActivity;
...
import com.allhdvideofree.downloader.videodownloader.activities.StoryDownloader.DhiFacebookActivity;
import com.allhdvideofree.downloader.videodownloader.Utils.ClipboardListener;

import java.util.Objects;

public class DhiFBSelectionActivity extends DhiActivityBase {

    LinearLayoutCompat lin_fblink, lin_fbweb;
    String CopyKey = "";
    String CopyValue = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhi_fbselection);


        setToolBar(DhiFBSelectionActivity.this,"All Video Downloader");

        lin_fblink = findViewById(R.id.lin_fblink);
        lin_fbweb = findViewById(R.id.lin_fbweb);
        ...
        lin_fblink.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        lin_fbweb.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new MainAds().showInterAds(DhiFBSelectionActivity.this, new InterAds.OnAdClosedListener() {
                    @Override
                    public void onAdClosed() {
                        Intent intent = new Intent(DhiFBSelectionActivity.this, DhiFbBrowserActivity.class);
    ...
    public void callFacebookActivity() {
        Intent intent = new Intent(this, DhiFacebookActivity.class);
