...
import com.allhdvideofree.downloader.videodownloader.activities.StoryDownloader.DhiTwitterActivity;
import com.google.gms.ads.BackInterAds;
import com.google.gms.ads.InterAds;
import com.google.gms.ads.MainAds;
import com.preference.PowerPreference;

public class DhiTwitterIntro extends DhiActivityBase {
    String CopyValue = "";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dhi_twitterinro);
        findViewById(R.id.txt_next).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                new MainAds().showInterAds(DhiTwitterIntro.this, new InterAds.OnAdClosedListener() {
                    @Override
                    public void onAdClosed() {
                        Intent intent = new Intent(DhiTwitterIntro.this, DhiTwitterActivity.class);
