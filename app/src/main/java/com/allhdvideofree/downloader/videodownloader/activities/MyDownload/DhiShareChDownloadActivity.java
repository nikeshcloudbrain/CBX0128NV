...
public class DhiShareChDownloadActivity extends DhiActivityBase implements FileListClickInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhi_sharechat_downloades);
        ...
        setToolBar(DhiShareChDownloadActivity.this,"Sharechat Downloader");
...
//            Prefences.setWATree(this, data.toString());
    ...
    public void getAllFiles() {
        ...
        File[] listFiles = MyUtils.RootDirectoryShareChatShow.listFiles();
        if (listFiles != null) {
