...
public class DhiStoryNextActivity extends DhiActivityBase {
    RelativeLayout nxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhi_story_next);

        nxt = findViewById(R.id.nxt);

        setToolBar(DhiStoryNextActivity.this, "All Video Downloader");

        nxt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new MainAds().showInterAds(DhiStoryNextActivity.this, new InterAds.OnAdClosedListener() {
                    @Override
                    public void onAdClosed() {
                        Intent intent = new Intent(DhiStoryNextActivity.this, DhiAllStoryActivity.class);
