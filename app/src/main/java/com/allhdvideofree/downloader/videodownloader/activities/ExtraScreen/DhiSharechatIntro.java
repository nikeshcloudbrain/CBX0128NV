...
import com.allhdvideofree.downloader.videodownloader.activities.StoryDownloader.DhiShareChatActivity;
import com.google.gms.ads.BackInterAds;
import com.google.gms.ads.InterAds;
import com.google.gms.ads.MainAds;
import com.preference.PowerPreference;

public class DhiSharechatIntro extends DhiActivityBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dhi_sharechat_intro);

        findViewById(R.id.txt_next).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                new MainAds().showInterAds(DhiSharechatIntro.this, new InterAds.OnAdClosedListener() {
                    @Override
                    public void onAdClosed() {
                        startActivity(new Intent(DhiSharechatIntro.this, DhiShareChatActivity.class));
                    }
                });
