...
public class InterAds {
    ...
    public void loadInterAds(Activity context) {
        ...
        if (mInterstitialAd == null && !interAd.equalsIgnoreCase("--") && PowerPreference.getDefaultFile().getInt(AdUtils.SERVER_INTERVAL_COUNT, 0) > 0) {
    ...
    public void loadInterAds2(Activity context) {
        ...
        if (mInterstitialAd2 == null && !interAd.equalsIgnoreCase("--") && PowerPreference.getDefaultFile().getInt(AdUtils.SERVER_INTERVAL_COUNT, 0) > 0) {
            AdRequest adRequest = new AdRequest.Builder().build();
